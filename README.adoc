...
- Type "HeadlessCms": Field "query" returns type "QueryResult" instead of an array of type "Content".

*NB! Make sure to wrap your query inside the "hits" field (https://developer.enonic.com/docs/guillotine/stable/usage#using_the_api[see example])*
