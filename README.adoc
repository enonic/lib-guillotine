...
- Type "TextComponentData": Field "value" returns "RichText" type instead of "String" and supports the `processHtml` argument of "ProcessHtmlInput" type.
- A form item of type "HtmlArea" returns "RichText" type instead of "String"
