...
- Type "TextComponentData": Field "value" returns "HtmlEditorResult" type instead of "String" and supports the `processHtml` argument of "ProcessHtmlInput" type.
- A form item of type "HtmlArea" returns "HtmlEditorResult" type instead of "String"
