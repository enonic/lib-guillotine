...
Starting from version 6.0.0 Guillotine library can be used without site. More details https://developer.enonic.com/docs/guillotine/stable/app-global-api[here].
