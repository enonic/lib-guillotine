...
abstract class FormDescriptorMapperBase
{
    protected void serializeForm( final MapGenerator gen, final Form form )
    {
        gen.array( "form" );
    ...
    protected void serializeItem( final MapGenerator gen, final FormItem item )
    {
    ...
    protected void serializeOccurrences( final MapGenerator gen, final Occurrences occurrences )
    {
        gen.map( "occurrences" );
    ...
    protected void serializeFormOptionSet( final MapGenerator gen, final FormOptionSet optionSet )
    {
        gen.map();
    ...
    protected void serializeOption( final MapGenerator gen, final FormOptionSetOption option )
    {
        gen.map();
    ...
    protected void serializeMultiselection( final MapGenerator gen, final Occurrences multiselection )
    {
        gen.map( "selection" );
    ...
    protected void serializeInput( final MapGenerator gen, final Input input )
    {
        gen.map();
    ...
    protected void serializeConfig( final MapGenerator gen, final InputTypeConfig config )
    {
        gen.map( "config" );
    ...
    protected void serializeConfigProperty( final MapGenerator gen, final InputTypeProperty property )
    {
        gen.map();
    ...
    protected void serializeDefaultValue( final MapGenerator gen, final Input input )
    {
