...
public class HtmlLinkProcessorTest
{
    ...
    public void test()
    {
        ...
        String result = instance.process( "" +
                                              "<figure class=\"editor-style-image-cinema\">" +
                                              "<img alt=\"matrix.jpg\" src=\"image://content-id?style=editor-style-image-cinema\" />" +
                                              "<figcaption>Caption</figcaption>" +
                                              "</figure>", "server", createPortalRequest(), Arrays.asList( 760, 1024 ), image -> {} );
        ...
        result = instance.process( "" +
                                       ...
                                       "<figcaption>Caption</figcaption>" +
                                       "</figure>", "server", createPortalRequest(), Arrays.asList( 1024, 2048 ), image -> {} );
